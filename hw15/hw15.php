...
//DRUGI ZADATAK
    ...
    for($i=0; $i<count($data); $i++){
        ...
        echo $data[$i]["name"] . " " . $data[$i]["last_name"] . " ima " . $data[$i]["age"] . " godina" . " i $gender.
        Ima prosecnu ocenu " . $data[$i]["avg_rating"] . " a kurseve koje trenutno slusa su: " . implode(", ",$data[$i]["courses"]) . ".";
        echo "<br><br>";
    }
