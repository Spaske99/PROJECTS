        ...
        <div class="container pt-5">
            <div class="row">
                ...
                <div class="col-6 mt-2 text-white">
                    ...
                    <div class="col-6 bac">
                        <a class="btn btn-outline-secondary previous-and-next" href="./single-product-page.php?page=<?php echo htmlspecialchars($prev['id']); ?>"><</a>
                        <a class="btn btn-outline-secondary previous-and-next" href="./single-product-page.php?page=<?php echo htmlspecialchars($next['id']); ?>">></a>
                    </div>
                </div>
            </div>
            <div class="row">
